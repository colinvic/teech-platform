  ...
  return (
    <div className="min-h-screen bg-surface">
      ...
      <main className="mx-auto max-w-lg px-4 pb-16 pt-8">
        ...
        {/* Ã¢ÂÂÃ¢ÂÂ Step 1: Profile Ã¢ÂÂÃ¢ÂÂ */}
        {step === 'profile' && (
          <div className="space-y-6">
            ...
            <button type="button" onClick={submitProfile} disabled={saving} className="btn-primary w-full">{saving ? 'SavingÃ¢ÂÂ¦' : 'Continue'}</button>
          </div>
        )}

        {/* Ã¢ÂÂÃ¢ÂÂ Step 2: WWC Ã¢ÂÂÃ¢ÂÂ */}
        {step === 'wwc' && (
          <div className="space-y-6">
            ...
            <div className="flex gap-3"><button type="button" onClick={() => setStep('profile')} className="btn-secondary flex-1">Back</button><button type="button" onClick={submitWwc} disabled={saving} className="btn-primary flex-1">{saving ? 'SavingÃ¢ÂÂ¦' : 'Continue'}</button></div>
          </div>
        )}

        {/* Ã¢ÂÂÃ¢ÂÂ Step 3: KYC Ã¢ÂÂÃ¢ÂÂ */}
        {step === 'kyc' && (
          <div className="space-y-6">
            <div><h1 className="text-2xl font-bold text-neutral-900">Identity verification</h1><p className="mt-1 text-sm text-neutral-500">Verify your identity using a government-issued ID. Powered by Stripe Identity Ã¢ÂÂ about 2 minutes.</p></div>
            {kycStatus === 'verified' ? (
              ...
              <div className="rounded-xl border border-neutral-200 bg-white p-5 space-y-4">
                {[
                  ...
                  { label: 'Live selfie required', desc: 'Your device camera will be used Ã¢ÂÂ no static uploads accepted' },
            ...
            <div className="flex gap-3">
              ...
              {kycStatus === 'verified'
                ...
                : <button type="button" onClick={startKyc} disabled={saving} className="btn-primary flex-1">{saving ? 'RedirectingÃ¢ÂÂ¦' : 'Verify identity with Stripe'}</button>
              }
            </div>
          </div>
        )}

        {/* Ã¢ÂÂÃ¢ÂÂ Step 4: Connect Ã¢ÂÂÃ¢ÂÂ */}
        {step === 'connect' && (
          <div className="space-y-6">
            <div><h1 className="text-2xl font-bold text-neutral-900">Payment setup</h1><p className="mt-1 text-sm text-neutral-500">Connect your bank account to receive payouts. Powered by Stripe Ã¢ÂÂ takes about 5 minutes.</p></div>
            ...
            <div className="flex gap-3">
              ...
              <button type="button" onClick={startConnect} disabled={saving} className="btn-primary flex-1">{saving ? 'RedirectingÃ¢ÂÂ¦' : 'Set up payments with Stripe'}</button>
            </div>
          </div>
        )}

        {/* Ã¢ÂÂÃ¢ÂÂ Step 5: Complete Ã¢ÂÂÃ¢ÂÂ */}
        {step === 'complete' && (
          <div className="space-y-6 text-center">
            ...
            <div><h1 className="text-2xl font-bold text-neutral-900">Onboarding complete</h1><p className="mt-2 text-sm text-neutral-500">Your profile is under review. Our team will verify your details and activate your account within 1Ã¢ÂÂ2 business days. You will receive an email when you go live.</p></div>
