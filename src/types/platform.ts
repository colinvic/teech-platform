// @ts-nocheck
/**
 * teech-platform Ã¢ÂÂ Platform Types
 * Single source of truth for all TypeScript types.
 * Never use `any`. Never cast unsafely.
 * All database joins use intersection types Ã¢ÂÂ never cast as `any`.
 */
...
// Age tiers Ã¢ÂÂ controls AI tone in report card and platform copy
export type AgeTier =
  | 'foundation_2'    // FoundationÃ¢ÂÂYear 2: warm, encouraging, emoji-rich
  | 'year_3_6'        // Year 3Ã¢ÂÂ6: friendly, clear, motivating
  | 'year_7_8'        // Year 7Ã¢ÂÂ8: peer-like, honest, direct
  | 'year_9_10'       // Year 9Ã¢ÂÂ10: analytical, respectful, real
  | 'senior_11_12'    // Year 11Ã¢ÂÂ12: coach-level, strategic
...
export interface Profile {
  ...
  date_of_birth: string | null     // ISO date Ã¢ÂÂ used to calculate age tier
  state: AuState | null
...
export interface TutorProfile extends Profile {
  ...
  acara_competency_scores: Record<string, number>  // sectionId Ã¢ÂÂ score
  hourly_rate: number
...
export interface SectionCard {
  ...
  alt_text: string | null          // accessibility Ã¢ÂÂ always required for images
...
export interface AssessmentSession {
  ...
  time_per_question_ms: number[]   // array Ã¢ÂÂ one entry per question
  anomaly_score: number            // 0Ã¢ÂÂ100; >70 = flagged
  flagged: boolean
...
export interface BadgeVerificationData {
  badge_id: string
  student_display_name: string     // full_name only Ã¢ÂÂ no surname
  section_name: string
  subject_name: string
  year_level: YearLevel
  score_percentage: number
...
export interface LearningIdentityData {
  ...
  consistency_score: number        // 0Ã¢ÂÂ100
...
export interface TutorSession {
  ...
  recording_consent: boolean       // false by default Ã¢ÂÂ explicit opt-in only
...
// Use intersection types for database joins Ã¢ÂÂ never cast as `any`
